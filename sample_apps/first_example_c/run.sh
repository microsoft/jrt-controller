...
run_background_command "cd $JRTC_PATH/sample_apps/first_example_c && source ../../setup_jrtc_env.sh && ./run_jrtc.sh"

sleep 3

# Step 2: Run Jbpf IPC agent
run_background_command "cd $JRTC_PATH/sample_apps/first_example_c && source ../../setup_jrtc_env.sh && ./run_simple_agent_ipc.sh"

sleep 1

# Step 3: Run reverse proxy
run_background_command "cd $JRTC_PATH/sample_apps/first_example_c && source ../../setup_jrtc_env.sh && ./run_reverse_proxy.sh"

sleep 1

# Step 4: Run decoder
run_background_command "cd $JRTC_PATH/sample_apps/first_example_c && source ../../setup_jrtc_env.sh && ./run_decoder.sh"

sleep 1

# Step 5: Load YAML (runs in the foreground)
echo "Running: Load YAML"
cd $JRTC_PATH/sample_apps/first_example_c && source ../../setup_jrtc_env.sh && ./load_app.sh
...
cd $JRTC_PATH/sample_apps/first_example_c && source ../../setup_jrtc_env.sh && ./unload_app.sh
