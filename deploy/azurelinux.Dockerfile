...
RUN echo "Installing specific versions of protoc-gen-go and protoc-gen-go-grpc" && \
    go install github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-grpc-gateway@v1.16.0 && \
    go install github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-openapiv2@v1.16.0 && \
